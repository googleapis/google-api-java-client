...
public final class Utils {
  ...
  /**
   * Returns if mTLS client certificate should be used. mTLS client certificate
   * is used if and only if "GOOGLE_API_USE_CLIENT_CERTIFICATE" environment variable
   * value is "true".
   * 
   ...
   * 
   * Default client certificate can be generated by running the commands in
   * ~/.secureConnect/context_aware_metadata.json file. If this json exists,
   * and the default client certificate exists, this function returns a KeyStore
   * object created with the default client certificate and the key store
   * password is "". Otherwise, null will be returned. 
   * 
