 ...
 *
 * <p>User-defined Partial JSON data models allow you to defined Plain Old Java Objects (POJO's) to
 ...
 *
 * <p>Let's take a look at a typical partial JSON-C video feed from the YouTube Data API (as
 * specified in <a href="https://developers.google.com/youtube/v3/code_samples/?csw=1">YouTube
 ...
 * </code></pre>
 *
 * <p>Now that we have a transport, we can execute a request to the YouTube API and parse the
 * result:
 *
 * <pre><code>
 ...
 * it's a lot easier.
 *
 * <p>NOTE: If you prefer to use your favorite JSON parsing library instead (there are many of them
