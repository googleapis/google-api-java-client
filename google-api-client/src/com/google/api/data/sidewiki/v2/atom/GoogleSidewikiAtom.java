...
package com.google.api.data.sidewiki.v2.atom;
...
/**
 * Utilities for the Atom XML format of the Google Sidewiki Data API.
 *
 * @deprecated (scheduled to be removed in version 1.1) Copy into your own
 * application
 */
@Deprecated
public final class GoogleSidewikiAtom {
  ...
  static {
    ...
    map.put("sidewiki", "http://schemas.google.com/sidewiki/2009");
    map.put("xml", "http://www.w3.org/XML/1998/namespace");
  }

  private GoogleSidewikiAtom() {
  }
}
