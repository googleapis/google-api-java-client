...
/**
 * Utilities for the Atom XML format of the Google Spreadsheets Data API.
 *
 * @deprecated (scheduled to be removed in version 1.1) Copy into your own
 * application
 */
@Deprecated
public final class GoogleSpreadsheetsAtom {
  ...
  static {
    ...
    map.put("gsx", "http://schemas.google.com/spreadsheets/2006/extended");
    map.put("openSearch", "http://a9.com/-/spec/opensearch/1.1/");
    map.put("xml", "http://www.w3.org/XML/1998/namespace");
  }

  private GoogleSpreadsheetsAtom() {
  }
}
