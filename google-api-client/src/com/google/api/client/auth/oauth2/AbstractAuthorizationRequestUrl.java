 ...
 * href="http://tools.ietf.org/html/draft-ietf-oauth-v2-07#section-4.1.1" >User-Agent Flow</a>.
 *
 * @since 1.0
 * @author Yaniv Inbar
 */
public abstract class AbstractAuthorizationRequestUrl extends GenericUrl {
   ...
   * SHOULD require the client to pre-register their redirection URI. Authorization servers MAY
   * restrict the redirection URI to not include a query component as defined by [RFC3986] section
   * 3.
   */
  @Key("redirect_uri")
  ...
  AbstractAuthorizationRequestUrl(String type, String encodedAuthorizationServerUrl) {
