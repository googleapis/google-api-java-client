 ...
 * in <a href="http://tools.ietf.org/html/draft-ietf-oauth-v2-07#section-4.1.1.1" >Authorization
 * Server Response</a>
 *
 * @since 1.0
 * @author Yaniv Inbar
...
public abstract class AbstractAuthorizationResponse extends GenericData {
   ...
   * @param readQueryParameters {@code true} to read query parameters or {@code false} to read
   *        fragment parameters
  ...
  AbstractAuthorizationResponse(String redirectUrl, boolean readQueryParameters) {
    try {
      ...
      String parameters = readQueryParameters ? uri.getRawQuery() : uri.getRawFragment();
