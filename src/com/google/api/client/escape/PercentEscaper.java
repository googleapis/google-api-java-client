...
public class PercentEscaper extends UnicodeEscaper {
  ...
  /**
   * A string of characters that do not need to be encoded when used in URI path
   ...
   * true then {@code c} should remain unmodified in the output. If {@code c >
   * safeOctets.length} then it should be escaped.
   */
  ...
  /**
   * Creates a boolean[] with entries corresponding to the character values for
   * 0-9, A-Z, a-z and those specified in safeChars set to true. The array is as
   * small as is required to hold the given character information.
   */
   ...
   * performance of the uri escaper from ~760ns to ~400ns as measured by {@link
  ...
  /*
   * Overridden for performance. For unescaped strings this improved the
   * performance of the uri escaper from ~400ns to ~170ns as measured by {@link
   * CharEscapersBenchmark}.
   */
  @Override
