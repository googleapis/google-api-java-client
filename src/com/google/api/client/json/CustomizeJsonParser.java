...
public class CustomizeJsonParser {
  ...
  /**
   * Returns whether to stop parsing at the given key of the given context
   * object.
   */
  ...
  /**
   * Called when the given unrecognized key is encountered in the given context
   * object.
   */
  ...
  /**
   * Returns a new instance value for the given field in the given context
  ...
  /**
   * Returns a new instance value for the given field class in the given context
