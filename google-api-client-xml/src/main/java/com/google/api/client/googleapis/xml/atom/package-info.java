 ...
 *
 * <p>The optional value parameter of this @{@link com.google.api.client.util.Key} annotation
 * specifies the XPath name to use to represent the field. For example, an XML attribute <code>a
 * </code> has an XPath name of <code>@a</code>, an XML element <code>&lt;a&gt;</code> has an XPath
 * name of <code>
 * a
 ...
 * it's a lot easier.
 *
 * <p>NOTE: If you prefer to use your favorite XML parsing library instead (there are many of them),
