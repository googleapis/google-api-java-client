...
abstract class AbstractLineWrapper implements LineWrapper {
  ...
  /**
   * Returns an index in the given string where the line should be broken. If no
   * cut is desired or no cut can be found, it should just return the line
   * length. Also, this method is responsible for updating the current line's
   * prefix, i.e. any additional indent to use after any subsequent cuts.
   * <p/>
   ...
   * return an index that is {@code <= maxWidth}.
   */
