...
/**
 * Processes multi-line comments like the ones in Java, i.e. those that start
...
final class JavaLikeCommentProcessor {
  ...
  /**
   * Multi-line comment start prefix or {@code null} if not inside a multi-line
   * comment.
   */
  ...
  /**
   * Processes the current line for a multi-line comment. Must be called
   * regardless of whether the line is going to be cut.
   */
  void processLine(String line) {
    /*
     * TODO: support case where multi-line comments don't start at beginning of
     * line or end at end of line
     */
  ...
  /**
   * Returns the current line's multi-line comment start prefix or {@code null}
   * for none.
   */
